...
public class LevelTest extends LevelBase{
		...
		static ActorMobil Relocation( ActorMobil pActor ) {
				...
				pActor.cLocation = new Float3( sXAncor, World3d.sGlobalRandom.nextFloat( PPgGame3d.sTheGame.getHeight()/2f ), 0f );	
						
						if( PPgGame3d.sTheGame.detectCollisionActor( (byte) 0, false, pActor, PPgGame3d.sTheGame.getActorLocation(), false ) == false )
								break;
